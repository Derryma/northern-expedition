...
export const ARMY_POSITIONS = {
  ...
  C: [
    { id: 'C-1', generalId: 'liu_xiang', general: '劉湘', designator: '第一軍', startCityId: 'chongqing', lon: 106.5, lat: 29.6, units: { infantry: 9, cavalry: 3, artillery: 1, machine_gun: 1 } },
    { id: 'C-2', generalId: 'liu_wenhui', general: '劉文輝', designator: '第二軍', startCityId: 'chengdu', lon: 104.1, lat: 30.7, units: { infantry: 8, cavalry: 3, artillery: 1, machine_gun: 1 } },
